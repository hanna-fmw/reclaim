...
The launchd agent (`com.hanna.disk-cleanup.plist`) fires daily at **08:45**. The
...
reclaim/
  ...
  com.hanna.disk-cleanup.plist  launchd schedule (daily 08:45)
...
~/Library/LaunchAgents/com.hanna.disk-cleanup.plist
